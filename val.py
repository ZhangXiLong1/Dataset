...
if __name__ == '__main__':
    model_path = 'runs/train/YOLOv8n-RCSOSA WiderPerson/weights/best.pt'
    # = 'runs/train/YOLOv8-C2f-Faster-m M3FD2/weights/last.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(
                        data='F:/YOLO/ultralytics-main/dataset/WiderPerson.yaml',
                        #data='F:/YOLO/ultralytics-main/dataset/LLVIP.yaml',
